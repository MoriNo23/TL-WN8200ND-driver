...
| 4 | **Android-ismos** — EJECUTADO 2026-08-22: ioctl Android privado cerrado (`CONFIG_RTW_ANDROID_PRIV_CMD=n`), NLRTW apagado + call sites guardados, `rtw_rhashtable.o` excluido (solo mesh/WDS lo usaban). Hallazgo honesto: nlrtw/rhashtable ya compilaban vacíos (defaults dentro del bloque MULTI_AP apagado) — el win real fue cerrar la superficie ioctl, no tamaño. `rtw_cfgvendor.o` se CONSERVA: aloja helpers vivos de SCAN_RAND/RSSIMONITOR | superficie ioctl reducida | hecho | ✅ |
